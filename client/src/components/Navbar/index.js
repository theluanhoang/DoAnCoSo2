            ...
            <div className={cx('navbar__container')}>
                ...
                <ul className={cx('navbar__icons')}>
                    ...
                    <li className={cx('navbar__icons--item')}>
                        ...
                        <div className={cx('navbar__icons--notification')}>{shoppingCart.length}</div>
                    </li>
                    <li className={cx('navbar__icons--item')}>
                        {
                            currentUser ? (
                                <Link to={''}>
                                    <img style={{ width: '30px' }} src={User} alt={currentUser.email} />
                                </Link>
                            ) :
                                <Link to={''}>
                                    <FaUserCircle />
                        ...
                        }
                        {
                            currentUser ?
                                (
                                    <ul className={cx('navbar__icons--list')} style={{ width: '200px', height: '150px' }}>
                                        {
                                            currentUser.admin && (
